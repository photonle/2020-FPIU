...
local name = "Lilys 2020 FPIU Rear Trunk Lightbar"
...
COMPONENT.Positions = {
	-- 
	[1] = { Vector( -7.3, 11.88, 46.1 ), Angle( -0, 5.5, 5.9 ), "solex_main", 5 },
	[2] = { Vector( 7.3, 11.88, 46.1 ), Angle( -0, -5.5, 5.9 ), "solex_main", 10 },
