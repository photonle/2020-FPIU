...
local name = "Lilys 2020 FPIU Headlight Flashers RB"
...
COMPONENT.Positions = {
	-- 
	[1] = { Vector( -31.22, -13.85, 36.92 ), Angle( 2, 59, 26 ), "solex_main", 10 },
	[2] = { Vector( 31.22, -13.88, 36.92 ), Angle( -2, -59, 26 ), "solex_main", 5 },
