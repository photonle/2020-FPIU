...
local name = "Lilys 2020 FPIU Exterior Lightbar"
...
COMPONENT.Sections = {
	...
	["auto_solex_inner"] = {
	   ...
	   -- [1] = { { 1, "_2" }, { 2, "_2" },{ 3, "_2" },{ 4, "_2" }, { 5, "_1" },{ 6, "_1" },{ 7, "_1" },{ 8, "_1" },},
		...
		[13] = { { 8, "_2" },{ 7, "_2" },{ 6, "_2" },{ 5, "_2" }, },
		[14] = { { 1, "_1" },{ 2, "_1" },{ 3, "_1" },{ 4, "_1" },},
	 },
...
COMPONENT.Patterns = {
	["auto_solex_inner"] = {
		["Stage1"] = {0,9,9,10,10,11,11,12,12,0,0,12,12,11,11,10,10,9,9,0,0,9,9,10,10,11,11,12,12,0,0,12,12,11,11,10,10,9,9,0,0},
		["Stage2"] = {5,6,7,8,4,3,2,1,0,1,2,3,4,8,7,6,5,0},
		["Stage3"] = {9,10,11,12,12,11,10,9},
	},
	["auto_spoiler_traffic"] = {
