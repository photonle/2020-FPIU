...
local name = "Lilys 2020 FPIU Headlight Flashers White"
...
COMPONENT.Positions = {
	-- 
	[1] = { Vector( -32.75	, -18.78, 37.08 ), Angle( 1.9, 78.5, 25.5 ), "solex_main", 10 },
	[2] = { Vector( 32.75, -18.78, 37.08 ), Angle( -1.9, -78.5, 25.9 ), "solex_main", 10 },
