...
local name = "Lilys 2020 FPIU Rambar Top"
...
COMPONENT.Positions = {
	-- Side
	[1] = { Vector( -16.7, 0.4, 20.7 ), Angle( 90, 90, 0 ), "solex_main", 10 },
	[2] = { Vector( 16.7, 0.4, 22.53 ), Angle( 90, -90, 0 ), "solex_main", 5 },
	[3] = { Vector( -16.7, 0.4, 22.53 ), Angle( 90, 90, 0 ), "solex_main", 5 },
	[4] = { Vector( 16.7, 0.4, 20.7 ), Angle( 90, -90, 0 ), "solex_main", 10 },
