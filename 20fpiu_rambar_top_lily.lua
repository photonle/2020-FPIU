...
local name = "Lilys 2020 FPIU Rambar Side"
...
COMPONENT.Positions = {
	-- Top
	[1] = { Vector( -8.9, -1.8, 29.45 ), Angle( 0, 0, 0 ), "solex_main", 10 },
	[2] = { Vector( 8.6, -1.8, 29.45 ), Angle( 0, -0, 0 ), "solex_main", 5 },
	[3] = { Vector( -6.8, -1.8, 29.45 ), Angle( 0, 0, 0 ), "solex_main", 5 },
	[4] = { Vector( 6.6, -1.8, 29.45 ), Angle( 0, -0, 0 ), "solex_main", 10 },
